...
@interface DocScannerRectangleFeature : NSObject
...
@end @implementation DocScannerRectangleFeature @end

@interface DocScannerViewController () <AVCaptureVideoDataOutputSampleBufferDelegate>
...
- (void)setCameraViewType:(DocScannerCameraViewType)cameraViewType
{
...
-(void)captureOutput:(AVCaptureOutput *)captureOutput didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer fromConnection:(AVCaptureConnection *)connection
{
    ...
    if (self.cameraViewType != DocScannerCameraViewTypeNormal)
    {
...
{
    return [CIFilter filterWithName:@"CIColorControls" keysAndValues:kCIInputImageKey, image, @"inputBrightness", @0.0f, @"inputContrast", @1.14f, @"inputSaturation", @0.0f, nil].outputImage;
}
...
- (CIRectangleFeature *)biggestRectangleInRectangles:(NSArray *)rectangles
{
    ...
    DocScannerRectangleFeature *rectangleFeatureMutable = [DocScannerRectangleFeature new];
